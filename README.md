...
[![Star this repo](https://img.shields.io/badge/⭐%20Star-real__world__llm__agents-ffcc00?style=flat&logo=github)](https://github.com/HeyNina101/real-world-llm-agents)



### 🧰 Extended starter agents

 - [🤔 Clarity Agent](extended_starter_agents/clarity_agent/README.md) - 
  Ask a question, get pros and cons. Built with multi-provider support (OpenAI & Anthropic). Easy to extend.
